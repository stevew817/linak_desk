                                       ...
                                       uint8_t * value)
{
    ...
    switch (clusterId)
    {
        ...
        case LevelControl::Id:
            ...
            break;
        default :
            ChipLogProgress(Zcl, " A cluster command was received with cluster %ld attribute ID: " ChipLogFormatMEI
            " Type: %u, Value: %u, length %u", clusterId, ChipLogValueMEI(attributeId), type, *value, size);
    }
}
